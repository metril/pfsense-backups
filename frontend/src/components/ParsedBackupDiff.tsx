...
const SECTION_LABELS: { key: keyof ConfigDiff; label: string }[] = [
  ...
  { key: "openvpn_servers", label: "OpenVPN servers" },
  { key: "openvpn_clients", label: "OpenVPN clients" },
  { key: "openvpn_cscs", label: "OpenVPN CSOs" },
  { key: "ipsec_phase1", label: "IPsec phase 1" },
  { key: "ipsec_phase2", label: "IPsec phase 2" },
