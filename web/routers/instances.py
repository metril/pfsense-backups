...
async def create_instance(
    ...
    inst = Instance(
        ...
        retention_keep_all_days=payload.retention_keep_all_days,
        retention_daily_days=payload.retention_daily_days,
        retention_weekly_weeks=payload.retention_weekly_weeks,
        retention_monthly_months=payload.retention_monthly_months,
...
async def update_instance(
    ...
    for field in (
        ...
        "enabled", "retention_count", "compress", "replicate",
        "stale_after_hours", "retention_keep_all_days", "retention_daily_days",
